...
public class CatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup)inflater.inflate(R.layout.fragment_cat, container, false);

        Button cat_btn = root.findViewById(R.id.cat_button);
        cat_btn.setOnClickListener( v-> {
            ConfirmDelete cd = new ConfirmDelete();
            cd.show(getParentFragmentManager(), "delete");
